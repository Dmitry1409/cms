	...
	<div class="device_cont">
		...
		<div class="lights_text device_text">
			<p><span class="green_defice">&mdash;</span>&nbsp;Алюминевый профиль</p>
			<span>Главным элементов конструкции световые линии являеться алюминивый профиль.
				<br>В него устанавливаеться пвх полотно натяжного потолка и светодиодная лента.
				<br>Основным критерием подбора профиля являеться ширина световой линии.
				<br>Варианты ширины 15мм, 30мм, 40мм, 50мм.</span>
			<p><span class="green_defice">&mdash;</span>&nbsp;Светодиодная лента</p>
			<span>В зависимости от ширины подобранного профиля можно установить одну или несколько светодиодныйх лент. Так же можно комбинировать можность, световое свечение лент между собой и таким образом получать различные варианты освещенности. Ничего не мешает установить и многоцветную ленту совмесно с монохромной лентой основного освещения.</span>
			<p><span class="green_defice">&mdash;</span>&nbsp;Фактура полотна</p>
			<span>Благодаря тому что алюминевый профиль делит комнату на множство отдельных полотен есть вариант подобрать цвет и фактуру каждого полотна по отдельности и таким образом создать не повторимый дизайн вашего помещения.</span>
		</div>
	</div>
