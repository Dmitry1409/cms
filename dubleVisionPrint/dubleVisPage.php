...
<div class="dubleVideo_wrapp">
	...
	<div>
		<p>Dublevision- это относительно новое направление в натяжных потолках. Главная идея dubleVision является в изменении внешнего вида потолка при включении выключении света. Это позволяет оформить потолок совершено новым и оригинальным способом.</p>
...
<div class="calcWrappFP">
	...
	<?php
		$res = $db->query("SELECT id, name, price FROM priceForCalcult WHERE id IN (1, 2, 3, 4, 5, 6, 7)");
		$val = [];
