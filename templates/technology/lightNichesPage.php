...
<?php
	$text_offer = "Заказать цена от 3500 р/м.п";
...
<div class="price_section">
	...
	<div class="price_table">
		<table>
			...
			<tbody>
				<?php
					$res = $GLOBALS['db']->query("SELECT * FROM product WHERE id IN (16,17,13,12,9,8,7,6)");
		...
		<div class="update_price">
			<span>Обновлено <?php $r = $GLOBALS['db']->querySingle("SELECT date FROM UpdatePriseData WHERE namePrise = 'lightNiches'"); echo $r;?></span>
		</div>
	</div>
</div>
