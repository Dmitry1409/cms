...
<div class="dubleVideo_wrapp">
	...
	<div>
		<p>Double Vision- это относительно новое направление в натяжных потолках. Главная идея double vision является в изменении внешнего вида потолка при включении выключении света. Это позволяет оформить потолок совершено новым и оригинальным способом.
		</p>
		<?php
			$text_offer = "Заказать цена от 1200 р/м2";
...
<div class="euipWrapp">
	...
	<div class="aferta_block">
		<div class="sale_flag">6000 руб.</div>
		<img style="border-radius: 4px;" src="../img/people.webp">
		<h4>Оформите заявку прямо сейчас и получи скидку в 6000 руб.</h4>
