...
<div class="lightsLines_flex">
	<div class="lights_img_cont">
		<picture>
			<source srcset="../img/imgObj/multiLevel/webp/potolki_par_05.webp" type="image/webp">
			<img src="../img/imgObj/multiLevel/jpg/potolki_par_05.jpg" alt="Световые линии это круто">
		</picture>
	</div>
	<div class="lights_text">
		<span>Усовершенствуйте интерьер своего дома или офиса с нашими двухуровневыми натяжными потолками. Эти потрясающие потолочные системы предлагают непревзойденную элегантность, функциональность и множество преимуществ, которые преобразят любое пространство. Двухуровневые натяжные потолки добавляют визуальный интерес и глубину вашему помещению. Они создают иллюзию более высоких потолков, делая комнаты просторнее и величественнее. Широкий выбор фактур и цветов позволяет создать уникальный и стильный дизайн, который будет соответствовать вашему вкусу и стилю декора.
		</span>
		<?php
			$text_offer = "Заказать цена от 1800 р/м.п";
			include "templates/zakaz_offer_block.php";
		?>
		<span>Свяжитесь с нами сегодня, чтобы заказать двухуровневый натяжной потолок, который превратит ваш дом или офис в шедевр стиля и функциональности. Добавьте изысканность, удобство и практичность в свое пространство с нашими превосходными потолочными решениями.</span>
		<p class="green_defice">Преимущества: </p>
		<div class="advan_cont">
			<span>
				<span class="green_defice">&mdash;</span> <span>&nbsp;Скрывают коммуникации</span>
			</span>
			<span>
				<span class="green_defice">&mdash;</span> <span>&nbsp;Зонирование пространства</span>
			</span>
			<span>
				<span class="green_defice">&mdash;</span> <span>&nbsp;Улучшение акустики</span>
			</span>
			<span>
				<span class="green_defice">&mdash;</span> <span>&nbsp;Безграничные возможности для дизайна</span>
			</span>
			<span>
				<span class="green_defice">&mdash;</span> <span>&nbsp;Быстрая установка</span>
			</span>
		</div>
	</div>
</div>
...
<div class="choiceConfSection">
	...
	<div class="noChelCont row-rewers">
		...
		<div class="NoChelRow">
			...
			в воздухе.</p>
			<?php
				$text_offer = "Заказать цена от 2000 р/м.п";
				include "templates/zakaz_offer_block.php";
			?>
			<div>
				<span>
	...
	<div class="noChelCont">
		...
		<div class="NoChelRow">
			...
			и теневым.</p>
			<?php
				$text_offer = "Заказать цена от 2300 р/м.п";
				include "templates/zakaz_offer_block.php";
			?>
			<div>
				<span>
