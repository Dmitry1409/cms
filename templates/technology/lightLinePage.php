	...
	<div class="lightsLines_flex">
		...
		<div class="lights_text">
			...
			<?php
				$text_offer = "Заказать цена от 550 р/м.п";
	...
	<div class="device_cont">
		<div class="device_img_cont">
			<picture>
				<source srcset='<?php echo $GLOBALS["root_dir"]."img/rendered/webp/fsdfsf3reb3b.webp"?>' type="image/webp">
				<img src='<?php echo $GLOBALS["root_dir"]."img/rendered/jpg/fsdfsf3reb3b.jpg"?>' alt="Устройство световых линий">
			</picture>
		</div>
	...
	<div class="price_section">
		...
		<div class="price_table">
			<table>
				...
				<tbody>
					<?php
						$res = $GLOBALS['db']->query("SELECT * FROM product WHERE id IN (5,6,7,8,9,10,11,12,13)");
			...
			<div class="update_price">
				<span>Обновлено <?php $r = $GLOBALS['db']->query("SELECT date FROM UpdatePriseData WHERE namePrise = 'svet_line'");
