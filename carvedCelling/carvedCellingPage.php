...
<div class="hederTopWrappCarved">
	...
	<div class="hederTextCarved">
		Резные потолки это еще один интересный вариант оформление современных помещений. Последнее время они стали очень попeлярны среди дизайнеров. Возможны варианты установки двух полотен в один уровень или с определенным расстоянием. Это расстояние между полотнами и придает объем потолку. Такие покрытия выглядят ярко насыщенно и оригинально.
	</div>
</div>
