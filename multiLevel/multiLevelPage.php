...
<div class="choiceConfSection">
	...
	<div class="choiseCofpagWrapp">
		<p>Существует большой выбор вариантов исполнения перехода с одного уровня на другой.
			...
			Есть три основных вида исполнения профиля это безщелевой переход, теневой переход и переход с подсветкой.
	...
	<div class="noChelCont">
		...
		<div class="NoChelRow">
			<p>Особенность этого профиля заключается в том, что преход с одного уровня на другой
	...
	<div class="noChelCont row-rewers">
		...
		<div class="NoChelRow">
			<p>В этом варианте исполнения особенностью являеться наличие теневого зазора между уровнями.
			Зазор получаеться около 2 см. Этот зазор предает отличный объем потолку, потолок как бы зависает
			в воздухе.</p>
	...
	<div class="noChelCont">
		...
		<div class="NoChelRow">
			...
			место для размещения светодиодной монохромной или мультиколорной ленты. Соответственно это профиль являеться 
			и теневым.</p>
			...
			<div>
				...
				<span>
					<span class="green_defice">&mdash;</span> <span>&nbsp;Декоротивная подсветка</span>
				</span>
			</div>
		</div>			
	</div>
...
<div class="design">
	...
	<div class="calculate_cont">
		...
		<?php
			$res = $db->query("SELECT id, name, price FROM priceForCalcult WHERE id IN (1, 2, 3, 4, 5, 6)");
			$val = [];
