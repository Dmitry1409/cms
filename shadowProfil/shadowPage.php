...
<div class="lightsLines_flex">
	...
	<div class="lights_text">
		<span>Благодаря наличию большой разновидности всевозможный стеновых профилей можно создавать
			...
			Выбирая наш паращий профиль вы получаете два в одном и декоративную подсветку и теневой профиль.
			...
			при глушенным светом при просмотре телевизора. Еще в нашем арсенале имеется профиль подсветки по
