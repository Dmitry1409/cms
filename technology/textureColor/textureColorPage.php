...
<div class="price_section">
	...
	<div class="price_table">
		<table>
			...
			<tbody>
				<?php
					$res = $db->query("SELECT * FROM product WHERE id > 26 AND id < 40");
					$arr = [];
		...
		<div class="update_price">
			<span>Обновлено <?php $r = $db->querySingle("SELECT date FROM UpdatePriseData WHERE namePrise = 'colorTexture'"); echo $r;?></span>
		</div>
	</div>
</div>
