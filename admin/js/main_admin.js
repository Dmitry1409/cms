...
function insert_load_indicator(wrap_elem){
	let html = `<div class='wrapp_load_indicator'>
					<svg class='load_indicator' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						 width="30px" fill='rgba(0,0,0,0.6)' height="30px" viewBox="0 0 613.705 613.705" style="enable-background:new 0 0 613.705 613.705;"
						 xml:space="preserve">
						 <g>
		...
		wrap_elem.insertAdjacentHTML('beforeend', html)
}
