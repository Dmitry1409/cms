			...
			switch ($key) {
				...
				case "световые линии":
					foreach ($value as $vsv) {
						...
						add_tov("Светод. лента 24V 12W ".$vsv->{'тип ленты'}, $vsv->{'м.п'}*$vsv->{'кол. лент'}, "Светод. лента 24V 12W");
						...
						if($vsv->{"кол. блоков"} !=""){
							...
							add_tov("блок питания ".$vsv->{'блок мощ.'}, $vsv->{"кол. блоков"}, "блок питания ".$vsv->{'блок мощ.'});
						}
					}
					break;
				case "парящий":
