...
<?php if($_SERVER["REQUEST_METHOD"] == "GET"){?>
	<p>Добавь фотки в папку "processed" выбери категорию работ и нажми отправить. Все фото конвертируются и сопируются в нужные папки и сделаются записи в базе. Нужно будет перекинуть фотки и базу на продакшн или грузить фотки изначально на продакшин</p>
